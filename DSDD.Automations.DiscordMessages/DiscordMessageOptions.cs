...
{
    [ConfigurationKeyName("TIMER_1_MESSAGE")]
    public string? Timer1Message { get; set; }

    [ConfigurationKeyName("TIMER_1_WEBHOOK_URL")]
    public string? Timer1WebhookUrl { get; set; }

    [ConfigurationKeyName("TIMER_2_MESSAGE")]
    public string? Timer2Message { get; set; }

    [ConfigurationKeyName("TIMER_2_WEBHOOK_URL")]
    public string? Timer2WebhookUrl { get; set; }

    [ConfigurationKeyName("TIMER_3_MESSAGE")]
    public string? Timer3Message { get; set; }

    [ConfigurationKeyName("TIMER_3_WEBHOOK_URL")]
    public string? Timer3WebhookUrl { get; set; }

    [ConfigurationKeyName("TIMER_4_MESSAGE")]
    public string? Timer4Message { get; set; }

    [ConfigurationKeyName("TIMER_4_WEBHOOK_URL")]
